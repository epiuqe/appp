...
@EnableZuulProxy
public class ApppApp {

    private static final Logger log = LoggerFactory.getLogger(ApppApp.class);

    private final Environment env;

    public ApppApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ApppApp.class);
